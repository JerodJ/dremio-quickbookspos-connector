...
@SourceType(value = "QuickBooksPOSARP", label = "QuickBooksPOS",uiConfig = "quickbookspos-layout.json")
public class QuickBooksPOSConf extends AbstractArpConf<QuickBooksPOSConf> {
  private static final String ARP_FILENAME = "arp/implementation/quickbookspos-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.quickbookspos.QuickBooksPOSDriver";
